        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          <a href="https://xata.io" className="w-10">
            <div
              ...
              className="css-1gtanqs"
            >
              <svg
                viewBox="0 0 24 24"
                focusable="false"
                className="chakra-icon css-n5gr1q"
                aria-hidden="true"
              >
                <g>
                  <path
                ...
                <defs>
                  ...
                  >
                    <stop stopColor="#9F87FF" />
                    <stop offset={1} stopColor="#8566FF" />
                  </linearGradient>
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop stopColor="#DE99F6" />
                    <stop offset={1} stopColor="#D669FC" />
                  </linearGradient>
                  <linearGradient
